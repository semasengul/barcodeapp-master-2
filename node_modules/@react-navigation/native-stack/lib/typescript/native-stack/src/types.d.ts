...
import { DefaultNavigatorOptions, Descriptor, NavigationHelpers, NavigationProp, ParamListBase } from '@react-navigation/core';
import { StackNavigationState, StackRouterOptions } from '@react-navigation/routers';
export declare type NativeStackNavigationProp<ParamList extends ParamListBase, RouteName extends keyof ParamList = string> = NavigationProp<ParamList, RouteName, StackNavigationState, NativeStackNavigationOptions, {}> & {
    /**
...
export declare type NativeStackNavigationHelpers = NavigationHelpers<ParamListBase, {}>;
